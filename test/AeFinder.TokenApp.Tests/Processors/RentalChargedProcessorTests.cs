...
public class RentalChargedProcessorTests: TokenContractAppTestBase
{
    ...
    public async Task HandleEventAsync_Test()
    {
        ...
        balancePayer[0].Amount.ShouldBe(99);
        balancePayer[0].FormatAmount.ShouldBe(0.00000099m);
        ...
        balanceReceiver[0].Amount.ShouldBe(1);
        balanceReceiver[0].FormatAmount.ShouldBe(0.00000001m);
    }
}